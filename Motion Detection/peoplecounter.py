...
while(1):
    ...
    cv2.putText(frame,'People Going Above = '+str(crossedAbove),(20,50), fo, 1,(255,255,255),1)
    cv2.putText(frame,'People Going Below = '+str(crossedBelow),(20,100), fo, 1,(255,255,255),1)
