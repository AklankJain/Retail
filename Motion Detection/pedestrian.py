...
fgbg = cv2.BackgroundSubtractorMOG2(history=150, varThreshold=150)
...
while(1):
    ...
    cv2.line(frame, (0, 160), (640, 160), (255, 0, 0), 4)
    cv2.line(frame, (0, 280), (640, 280), (255, 0, 0), 4)

    print crossedAbove,crossedBelow
    cv2.putText(frame,'People Going Above = '+str(crossedAbove),(200,50), font, 1,(255,255,255),2)
    cv2.putText(frame,'People Going Below = '+str(crossedBelow),(200,100), font, 1,(255,255,255),2)
